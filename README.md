...
[**artist2playlist_api**](spotify/artist2playlist_api.py) - Same functionality as artist2playlist, but uses the setlist.fm API instead of web scraping. More error handling and separation of concerns.
